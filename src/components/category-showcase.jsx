      ...
      <div className=" px-4 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto text-center mb-12">
          <h2 className="text-4xl lg:text-5xl font-light text-gray-800">
            ...
            <Sparkles className="inline-block ml-2 w-8 h-8 text-red-400/70" />
          </h2>
        </div>
        ...
        <div className="flex max-lg:flex-wrap justify-center items-center gap-6 mb-20 p-10">
          {categories.map((category, index) => (
            <Link key={index} href={`/${category.slug}`}>
              <div className="relative h-[24rem] w-[20rem] rounded-lg overflow-hidden shadow-lg aspect-square group cursor-pointer drop-shadow-lg">
                <Image
